...
class LongTermRentalsPage extends Page implements HasForms
{
    ...
    public function form(Form $form): Form
    {
        return $form
            ->schema([
                Forms\Components\Tabs::make('Page Configuration')
                    ->tabs([
                        ...
                        Forms\Components\Tabs\Tab::make('FAQs & Map')
                            ->schema([
                        ...
                        Forms\Components\Tabs\Tab::make('Sidebar')
                            ->schema([
                                Forms\Components\Section::make('Sidebar Visibility')
                                    ->schema([
                                ...
                                Forms\Components\Section::make('Search Widget Content')
                                    ->schema([
