        ...
        <div class="lg:col-span-1 space-y-8">
            ...
            <div class="bg-card-light dark:bg-card-dark rounded-2xl shadow-xl p-6 border border-gray-100 dark:border-gray-700">
                <div class="flex items-center gap-4 mb-6">
                    <img alt="Agent Photo" class="w-16 h-16 rounded-full object-cover border-2 border-primary" src="https://lh3.googleusercontent.com/aida-public/AB6AXuDXqkOGQ2MHPaESBUQWOBF844hRoq2ENPpjICNXI91jzKJkuk6kmbPihysF8P2bxWEILNKD2Dp5AmaGXEA9ASBmVO63Y2SDjPM_MbDIVR6iJIKWu5tAZn4SVoJk5HHsd83xiFnLGxr5MwM_qhA9Am2FtOyhnVDNkn35-UvAe8M7dAHqJMIKQi-k3SPkC6OE_oKG7F0NCZpTG19SxBMk7BlqEeXfwWnNxCb7i3znERNpPZPnr8qU34BEdKg8yOfH6FqwjIuUp1kzBOkn">
                    <div>
                        <h3 class="text-lg font-bold text-gray-900 dark:text-white">Alex Nguyen</h3>
                        <p class="text-primary text-sm font-medium">Your friendly neighborhood buddy</p>
                    </div>
                </div>
                <p class="text-gray-600 dark:text-gray-300 text-sm mb-6 leading-relaxed">
                    "Hi! I'm Alex. I've lived in Phu Quoc for over 5 years and helped hundreds of expats and travelers find their dream home. Ask me anything about rentals or the best coffee spots!"
                </p>
                
                <div class="space-y-4">
                    <a class="flex items-center gap-3 text-gray-600 dark:text-gray-300 hover:text-primary dark:hover:text-primary transition-colors group" href="mailto:hello@pqrentals.com">
                        ...
                        <span class="font-medium">hello@pqrentals.com</span>
                    </a>
                    <a class="flex items-center gap-3 text-gray-600 dark:text-gray-300 hover:text-primary dark:hover:text-primary transition-colors group" href="tel:+84902607024">
                        <div class="w-10 h-10 rounded-full bg-blue-50 dark:bg-blue-900/20 flex items-center justify-center text-primary group-hover:bg-primary group-hover:text-white transition-colors">
                            <span class="material-icons text-xl">phone</span>
                        </div>
                        <span class="font-medium">+84 902-607-024</span>
                    </a>
                    <div class="flex items-center gap-3 text-gray-600 dark:text-gray-300 group">
                        ...
                        <span class="font-medium">Sunset Town, Phu Quoc, Vietnam</span>
                    </div>
                </div>
                ...
                <div class="mt-8 pt-6 border-t border-gray-100 dark:border-gray-700">
                    ...
                    <div class="flex gap-4">
                        <a class="w-10 h-10 rounded-lg bg-gray-100 dark:bg-gray-800 flex items-center justify-center text-gray-600 dark:text-gray-400 hover:bg-primary hover:text-white dark:hover:bg-primary dark:hover:text-white transition-all" href="#">
            ...
            <div class="bg-card-light dark:bg-card-dark rounded-2xl shadow-lg p-6 border border-gray-100 dark:border-gray-700">
                ...
                <ul class="space-y-3 text-sm text-gray-600 dark:text-gray-300">
                    ...
                    <li class="flex justify-between">
                        <span>Saturday</span>
                        <span class="font-medium text-gray-900 dark:text-white">9:00 AM - 4:00 PM</span>
                    </li>
                    <li class="flex justify-between">
                        <span>Sunday</span>
            ...
            <div class="bg-card-light dark:bg-card-dark rounded-2xl shadow-xl p-8 border border-gray-100 dark:border-gray-700">
                ...
                <form action="#" method="POST" class="space-y-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2" for="name">Your Name</label>
                            <input class="w-full rounded-lg border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:ring-primary focus:border-primary px-4 py-3" id="name" name="name" placeholder="John Doe" type="text"/>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2" for="email">Email Address</label>
                            <input class="w-full rounded-lg border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:ring-primary focus:border-primary px-4 py-3" id="email" name="email" placeholder="john@example.com" type="email"/>
                        </div>
                    </div>
                    <div>
                        ...
                        <select class="w-full rounded-lg border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:ring-primary focus:border-primary px-4 py-3" id="interest" name="interest">
                            <option>Long-term Rental Apartment</option>
                            <option>Short-term Holiday Stay</option>
                            <option>Motorbike Rental</option>
                            <option>General Inquiry</option>
                        </select>
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2" for="message">Message</label>
                        <textarea class="w-full rounded-lg border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:ring-primary focus:border-primary px-4 py-3" id="message" name="message" placeholder="Tell us what you are looking for..." rows="4"></textarea>
                    </div>
                    <button class="w-full md:w-auto bg-primary hover:bg-secondary text-white font-bold py-3.5 px-8 rounded-lg shadow-lg shadow-primary/30 transition-all transform hover:-translate-y-1 flex items-center justify-center gap-2" type="submit">
                        Send Message
