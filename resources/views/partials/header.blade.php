    ...
    <div class="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-20">
            ...
            <nav class="hidden md:flex items-center space-x-1">
                ...
                <a class="{{ request()->routeIs('motorbikes.*') ? 'text-primary font-semibold bg-blue-50 dark:bg-blue-900/20' : 'text-gray-600 dark:text-gray-300 hover:text-primary dark:hover:text-primary' }} px-6 py-2.5 rounded-full transition-all font-medium" href="{{ route('motorbikes.index') }}">Motorbikes</a>
        ...
        <div id="mobile-menu" class="hidden md:hidden pb-4 pt-2 border-t border-gray-200 dark:border-gray-700">
            <nav class="flex flex-col space-y-2 mt-2">
                ...
                <a class="{{ request()->routeIs('motorbikes.*') ? 'text-primary font-semibold bg-blue-50 dark:bg-blue-900/20' : 'text-gray-600 dark:text-gray-300 hover:text-primary dark:hover:text-primary' }} px-4 py-2.5 rounded-lg transition-all font-medium" href="{{ route('motorbikes.index') }}" onclick="closeMobileMenu()">Motorbikes</a>
